// *** PUNTO DE VENTA ***
// *** DE 100 PRODUCTOS CON PROMOCIONES ***

#include <stdio.h>
void main (void)
{
    //definimos el tamaño que tendrán nuestros arreglos multi y productos
    #define TAMANO 100
    /*
        Definimos el tamaño que tendrán nuestros arrelgos "promocion", "division" y "residuo", 
        estos son para aplicar las promociones
    */
    #define PROMOCIONES 30
    float multi[TAMANO], totalDePago;
    int  totalpro, codigo, productos[TAMANO], promocion[30], division[30], residuo[30], i, pago, totalDeProductos;
    char aa = 160, ae = 130, ai = 161, ao = 162, aoo = 224, au = 163, an = 164, ap = 168, ii = 173, ac = 39, p = 37;

    //Este es el mensaje de bienvenida que aparecerá al ejecutarse el programa
    printf("---------------------------------------------------------------------------------------------------------------------------------------");
    printf ("\n\t\t\t\t\t\t\t BIENVENIDO \n");
    ...
    do 
    {
        ...
        switch (codigo)
        {
            ...
            // las cuales definen el monto a pagar y las promociones aplicadas (en productos con promociones)
            /*
                En los productos "normales" que no tienen promociones, se va a multiplicar el precio sin IVA
